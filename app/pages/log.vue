...
const timeline = {
	'2025-07-26': ['博客：迁移 Nuxt Content 3，并更换域名 ', h('code', 'zhilu.site')],
	...
	'2020-08-10': ['个人网站：更换域名 ', h('code', 'zhilu.cyou')],
	'2019-12-27': 'Slogan：纸鹿至麓不知路，支炉制露不止漉',
	'2019-07-19': '个人网站：使用 Jekyll，发布第一篇文章',
	'2019-05-24': ['个人网站：购买域名 ', h('code', 'zhilu.fun')],
	'2019-03-01': ['Logo：', h(ZhiluIcon)],
	'2019-02-06': 'Slogan：纸鹿山行云潜日，日潜云行山路止',
	'2017-09-08': ['Logo：', h(ZhiluIconOld), ' PaperyDeer'],
	'2016-06-28': ['开始使用昵称 ', h('code', '纸鹿君_L33Z22L11'), ' 在互联网上活跃'],
}
</script>
